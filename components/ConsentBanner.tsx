...
export const ConsentBanner: React.FC<ConsentBannerProps> = ({ onAccept, onReadPolicy, onReadTerms }) => {
  return (
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="text-sm text-slate-300">
            ...
            <p className="text-slate-400 text-xs leading-relaxed">
              ...
              By continuing, you agree to our <button onClick={onReadPolicy} className="text-indigo-400 hover:text-indigo-300 underline underline-offset-2">Privacy Policy</button> and <button onClick={onReadTerms} className="text-indigo-400 hover:text-indigo-300 underline underline-offset-2">Terms of Service</button>.
            </p>
          </div>
        </div>
